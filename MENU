(async () => {
    ...
    if (console.log("%c Xanders Blooket Hacks / Cheats %c\n	Modified by Xander on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/Zip-On/Blooket-Cheat-GUI-aka-Swaggers-GUI", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Xanders Blooket Cheats<sup>v2</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
    ...
    let C = {
        ...
        crypto: [{
            ...
            name: "Crash Password",
            description: "Crashes other players when they attempt to hack you (dangerous)",
            type: "toggle",
            enabled: !1,
            data: null,
            run: function() {
            ...
            name: "Screw up their game!(Crypto)",
